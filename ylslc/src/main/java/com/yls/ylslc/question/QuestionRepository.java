...
public interface QuestionRepository extends JpaRepository<QuestionEntity, UUID> {
        ...
        Page<QuestionEntity> searchByTitleOrNumber(@Param("user") UserEntity user,
        ...
        @Query("SELECT q.dateOfCompletion AS dateOfCompletion, COUNT(q) AS count FROM QuestionEntity q WHERE q.user.id = :userId GROUP BY q.dateOfCompletion ORDER BY q.dateOfCompletion DESC")
